...
def app():
    ...
    start = st.date_input('Start' , value=pd.to_datetime('2002-02-01'))
    end = st.date_input('End' , value=pd.to_datetime('2022-01-24'))
    df = pd.read_csv('PeruTipoDeCambio.csv')
  
    #df = pd.read_csv('PeruTipoDeCambio.csv', start, end)
    ...
    st.subheader('Datos hasta el 2022') 
